...
> **前置依赖**：开始之前请先完成：
>
> 1. [环境配置](environment_preparation-zh-CN.md)
> 2. [数据准备](data_preparation-zh-CN.md)
> 3. [模型权重准备](model_weights_preparation-zh-CN.md)

> **多卡数量提醒**：默认配置基于 8 GPU。其它卡数请先阅读 [hardware_scaling-zh-CN.md](hardware_scaling-zh-CN.md)。
